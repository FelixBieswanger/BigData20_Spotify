...
#   n = 0                       #Amount of parameteres
    a_list = [1, 1, 0, 1]      #Index if parameter i is same, wayne or contrary
    w_list = [1, 1, 1, 1]       #Weight of parameter i
#   p = []                      #Value of parameter i for current song
#   q = []                      #Value of parameter i for potential next song
    b_list = [0, 0, 0, 0]       #Standard deviation for parameter i, gets added if contrary
